                    ...
                    <div class="row">
                        <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                            <div class="animated bounceInDown slider-captions">
                                <h1 class="slider-title ">“Donate blood and be the reason of smile to many faces.”</h1>
                ...
                <div class="row">
                    <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                        <div class="slider-captions ">
                            <h1 class="slider-title">"There is a hope of life to someone in your blood donation.”</h1>
        ...
        <div class="item">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                        <div class="slider-captions ">
                            <h1 class="slider-title">"Life is in blood – donate Blood – give life</h1>
                            <p class="slider-text hidden-xs"></p>
                        </div>
                    </div>
                </div>
